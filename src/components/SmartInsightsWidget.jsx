...
import { BrainCircuit, ShieldAlert, TrendingDown, Coins, Activity, ArrowRight, Zap, Target } from 'lucide-react';

const SmartInsightsWidget = ({ insights }) => {
  const [impulseAmount, setImpulseAmount] = useState('');

  // The Loading Skeleton ensures the widget is always visible while the backend crunches the math
  if (!insights) {
    return (
  ...
  return (
    <div className="mb-8 space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#0A3D8B] to-[#1E3A8A] dark:from-[#1A2235] dark:to-[#121212] rounded-2xl p-6 text-white shadow-lg relative overflow-hidden border border-transparent dark:border-[#262626]">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between md:items-center gap-4">
          ...
          <div className="bg-white/10 dark:bg-black/20 p-4 rounded-xl backdrop-blur-sm w-full md:w-72">
